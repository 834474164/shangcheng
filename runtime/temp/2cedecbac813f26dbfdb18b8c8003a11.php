<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\www\shangcheng\public/../application/home\view\index\loginview.html";i:1534304427;}*/ ?>
<!DOCTYPE html>
<html>
	...
	<div class="login-box">
		...
		<div class="loginArea">
				...
				<div class="loginform">
					...
					<div class="tab-content tab-wraped">
						...
						<div id="profile" class="tab-pane  active">
							<form class="sui-form" id="on_submit" action="<?php echo url('index/login'); ?>" method="post">
          ...
          自动登录
								...
								<div class="logined">
									<button class="sui-btn btn-block btn-xlarge btn-danger" href="javascript:;" target="_blank">登&nbsp;&nbsp;录</button>
								</div>
							</form>
