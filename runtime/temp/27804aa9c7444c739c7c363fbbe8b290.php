<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"D:\www\shangcheng\public/../application/admin\view\manager\addview.html";i:1535349944;s:52:"D:\www\shangcheng\application\admin\view\layout.html";i:1532697794;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="content">
    ...
    <div class="well">
        <!-- add form -->
        <form action="<?php echo url('add'); ?>" method="post" id="tab">
            <label>用户名：</label>
