<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"D:\www\shangcheng\public/../application/home\view\goods\detail.html";i:1535424130;s:51:"D:\www\shangcheng\application\home\view\layout.html";i:1535682313;}*/ ?>
<!DOCTYPE html>
<html>
				...
				<div class="fl preview-wrap">
					...
					<div class="zoom">
						...
						<div id="preview" class="spec-preview">
							<span class="jqzoom"><img jqimg="<?php echo $pics[0]['pics_big']; ?>" src="<?php echo $pics[0]['pics_sma']; ?>" /></span>
						</div>
						<!--下方的缩略图-->
						<div class="spec-scroll">
							...
							<div class="items">
								<ul>
									...
									<li><img src="<?php echo $p['pics_sma']; ?>" bimg="<?php echo $p['pics_big']; ?>" onmousemove="preview(this)" /></li>
                                    <?php endforeach; ?>
								</ul>
							</div>
							<a class="next">&gt;</a>
				...
				<div class="fr itemInfo-wrap">
					...
					<div class="summary">
						<div class="summary-wrap">
							...
							<div class="fl price">
								<i>¥</i>
								<em><?php echo $goods_info['goods_price']; ?></em>
								<span>降价通知</span>
							</div>
							<div class="fr remark">
						...
						<div class="tab-content tab-wraped">
							<div id="one" class="tab-pane active">
								...
								<div class="intro-detail">
									<img src="<?php echo config('home_img'); ?>_/intro01.png" />
									<img src="<?php echo config('home_img'); ?>_/intro02.png" />
									<img src="<?php echo config('home_img'); ?>_/intro03.png" />
								</div>
							</div>
