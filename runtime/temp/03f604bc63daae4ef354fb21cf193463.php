<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"D:\www\shangcheng\public/../application/admin\view\order\editview.html";i:1535780066;s:52:"D:\www\shangcheng\application\admin\view\layout.html";i:1532697794;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="sidebar-nav">
    ...
    <div class="content">
        <div class="header">
            <h1 class="page-title">订单信息修改</h1>
        </div>

        <div class="well">
            <!-- edit form -->
            <form action="<?php echo url('admin/order/edit'); ?>" method="post" id="tab">
                ...
                <label>订单金额：</label>
                <input type="text" name="order_amount" value="<?php echo $order['order_amount']; ?>" class="input-xlarge">
                <label>收件地址：</label>
                <input type="text" name="consignee_address" value="<?php echo $order['consignee_address']; ?>" class="input-xlarge">
