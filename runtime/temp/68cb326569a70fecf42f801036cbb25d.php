<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"D:\www\shangcheng\public/../application/admin\view\manager\index.html";i:1535358097;s:52:"D:\www\shangcheng\application\admin\view\layout.html";i:1532697794;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<script>
    $(function(){
        $(".delete_manager").click(function(){
            ...
            var _this=this;
           $.ajax({
             "url":"<?php echo url('admin/manager/delete'); ?>",
             'datatype':"json",
             'data':data,
             'type':'post',
...
<div class="content">
    ...
    <div class="well">
        ...
        <form action="" method="get" class="form-search">
            ...
            <a class="btn btn-primary" href="<?php echo url('admin/manager/addview'); ?>">新增</a>
        </form>
    </div>
    <div class="well">
        <!-- table -->
        <table class="table table-bordered table-hover table-condensed">
            ...
            <?php foreach($list as $k=>$v): ?>
                <tr class="success">
                    ...
                    <td>
                        <a href="javascript:void(0);" class="delete_manager" now_id="<?php echo $v['id']; ?>"> 删除 </a>
                    </td>
                </tr>
            <?php endforeach; ?>
            </tbody>
