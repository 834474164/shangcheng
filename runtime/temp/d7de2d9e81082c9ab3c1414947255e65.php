<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"D:\www\shangcheng\public/../application/admin\view\attribute\index.html";i:1532870530;s:52:"D:\www\shangcheng\application\admin\view\layout.html";i:1532697794;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
        ...
        <a class="btn btn-primary" href="<?php echo url('createview'); ?>">新增</a>
            ...
            <table class="table table-bordered table-hover table-condensed">
                ...
                <?php foreach($attribute as $k=>$v): ?>
                    <tr attr_id="<?php echo $v['id']; ?>" class="success">
                        <td><?php echo $k; ?></td>
